# Objects.h
Objects Is a Very Straightforward Header File Made in C++ Used for General Programming.

Objects Contains Over 1000 Lines of Code And It Is A C++ Shortener.
...
```
Objects Is Full Of Featured Classes & Definitions To Get Anybody Started On C++.

Objects Gives you More Control Over Your Programming By Providing Easy-To-Master Syntax & Very Simple Statements.
...
Objects Can do But is not limited to;
...
- Multiple Framework Support (2 And Growing!)

- API Handling

- InputOutput Stream Writing

- Automatically Writting 30+ Lines Of Code In one Function

# Deep Integration With ExclamationScript
Objects Has Some Deep integration With ExclamationLanguage And It's Addition Of Functions.

The Integration Works As Shown Below. (Some of it is incorrect, It's just a Rough Layout.)

```c++
#include "Objects.h" // Obviously

int main() {
    ExclamationLanguageBase This = *new ExclamationLanguageBase;
    ExclamationParser Me = *new ExclamationParser;
    bool i = This.Return("thisfile.excla");
    if (i) {
        Me.Main = "main.excla";
        
        Me.Debug(); // Debug File
        
        Me.Extract("Exportables"); // Extract Exported Functions!
    }
}
```

*(This Header Is Proprietary And Is Only Distributed In Source .ZIP Only. See the License For More Information.)*



# LICENSE
This Project & ExclamationLanguage Uses the SETL License With the TOBL 1.2 License.

[Check here for the License.](LICENSE)